...
namespace Text
{
	void RegexNodeVisitor::VisitCharSetNode(RegexCharSetNode * node)
	{
	}

	void RegexNodeVisitor::VisitRepeatNode(RegexRepeatNode * node)
	{

	}

	void RegexNodeVisitor::VisitSelectionNode(RegexSelectionNode * node)
	{
	}

	void RegexNodeVisitor::VisitConnectionNode(RegexConnectionNode * node)
	{
